...
class CarrotDetailScreen extends StatefulWidget {
  const CarrotDetailScreen({Key? key}) : super(key: key);

  @override
  State<CarrotDetailScreen> createState() => _CarrotDetailScreenState();
}

class _CarrotDetailScreenState extends State<CarrotDetailScreen> {
  int itemCount = 0;
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    " Organic carrots are grown using natural fertilizers "
                        "and are less likely to have pesticide residues "
                        "because they're protected against pests and diseases using mechanical and biological methods.",
                    style: TextStyle(
